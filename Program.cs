...
class Program
{
    static async Task Main(string[] args)
    {
        ...
        // код для отправки HTTP запросов и получения ответов который перестанет работать когда он будет не нужен благодаря ключевому слову using тем самым уменьшая нагрузку на программу в целом
